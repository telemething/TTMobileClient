...
namespace TTMobileClient
{
	...
	public class OpenGLDemoApp : Xamarin.Forms.Application
	{

			public OpenGLDemoApp()
			{
...
#if __IOS__
				prefix = "TTMobileClient.iOS.Shaders.";
#endif
#if __ANDROID__
            prefix = "TTMobileClient.Droid.Shaders.";
			#endif

			//var assembly = typeof(App).GetTypeInfo ().Assembly;

            var assembly = IntrospectionExtensions.GetTypeInfo(typeof(TTMobileClient.OpenGLDemoApp)).Assembly;
